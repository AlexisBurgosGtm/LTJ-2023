...
router.post('/historialcliente',async (req,res)=>{
    ...
    let qry = `
    SELECT 
            ME_Documentos.CODDOC, ME_Documentos.DOC_NUMERO AS CORRELATIVO, 
            ME_Documentos.DOC_FECHA AS FECHA, ME_Documentos.NITCLIE, 
            ME_Docproductos.CODPROD, ME_Docproductos.DESCRIPCION AS DESPROD,
            ME_Docproductos.CODMEDIDA, ME_Docproductos.CANTIDAD, 
            ME_Docproductos.PRECIO, ME_Docproductos.TOTALPRECIO
    FROM ME_Documentos LEFT OUTER JOIN
            ...
            ME_Documentos.CODSUCURSAL = ME_Docproductos.CODSUCURSAL 
            AND ME_Documentos.EMP_NIT = ME_Docproductos.EMP_NIT LEFT OUTER JOIN
    ...
    WHERE (ME_Documentos.CODSUCURSAL = '${sucursal}') 
            AND (ME_Documentos.NITCLIE = '${codcliente}') 
            ORDER BY ME_Documentos.DOC_FECHA DESC
    `;
